...
\begin{thebibliography}{1}
	...
	\bibitem{state-machine} CREMER, James, KEARNEY, Joseph, et PAPELIS, Yiannis. HCSM: a framework for behavior and scenario control in virtual environments. \textit{ACM Transactions on Modeling and Computer Simulation (TOMACS)}, 1995, vol. 5, no 3, p. 242-267.
	\bibitem{seven} CLAUDE, Guillaume, GOURANTON, Valérie, BERTHELOT, Rozenn Bouville, et al. Short Paper:\# SEVEN, a Sensor Effector Based Scenarios Model for Driving Collaborative Virtual Environment. In : \textit{ICAT-EGVE, International Conference on Artificial Reality and Telexistence, Eurographics Symposium on Virtual Environments}. 2014. p. 1-4.
\end{thebibliography}
