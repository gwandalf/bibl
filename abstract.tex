...
There are 4 types of communication means: audio, visual, embodiment, and text. It is recommended to use several of them together in order to be complete. Nevertheless, communication means should be chosen in accordance to the application needs and the devices restrictions.
